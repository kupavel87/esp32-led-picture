...
<div class="card">
    ...
    <div id="collapse{{ prop['alias'] }}" class="collapse" aria-labelledby="head{{ prop['alias'] }}" data-parent="#accordion">
        <div class="card-body">
            <button class="btn btn-success" id="start" value={{ prop['id'] }}>Старт</button>
        </div>
        <div class="card-body">
            <form id="property">
                <div class="row">
                    <div class="col">
                        ...
                        <input type="range" class="custom-range" min="10" max="50" step="5" id="customRange1"
                            name="speed" value={{prop['property']['speed']}}>
                    </div>
                    <div class="col">
                        <label for="customRange2">Плотность</label>
                        <input type="range" class="custom-range" min="10" max="100" step="10" id="customRange2"
