    ...
    <div id="collapse{{ prop['alias'] }}" class="collapse" aria-labelledby="head{{ prop['alias'] }}" data-parent="#accordion">
        ...
        <div class="card-body">
            <form id="property">
                <div class="row">
                    <div class="col">
                        <label for="customRange1">Частота</label>
                        <input type="range" class="custom-range" min="1" max="20" step="1" id="customRange1"
                            name="speed" value={{ prop['property']['speed'] }}>
                    </div>
                    <div class="col">
                        <label for="customRange2">Размытие</label>
                        <input type="range" class="custom-range" min="0" max="100" step="1" id="customRange2"
                            name="pcnt" value={{ prop['property']['pcnt'] }}>
                    </div>
                    <div class="col">
                        <label for="customRange3">Цвет</label>
                        <input type="range" class="custom-range colorHSV" min="0" max="100" step="1" id="customRange3"
